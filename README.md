...
| <b>padding</b>([<i>string</i> or <i>fn</i>]) | Getter/setter for the amount of padding between adjacent blocks, in px. | `2.5` |
...
| <b>tooltipContent</b>([<i>string</i> or <i>fn</i>]) | Getter/setter for a node object tooltip content accessor. Use this to specify extra content in each of the block's tooltips in addition to the node's full hierarchical name that's included by default. | |
